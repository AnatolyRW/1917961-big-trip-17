...
const renderPhotos = (distinationModel, checkedDestination) => {
  const pointDestination = distinationModel.destinations.find((destination) => destination.name === checkedDestination.name);
        ...
        <section class="event__section  event__section--destination">
          ...
          <div class="event__photos-container">
            <div class="event__photos-tape">
             ${renderPhotos(destinationModel, destination)}
             </div>
          </div>
        </section>
      </section>
...
export default class AddTripEventView extends AbstractStatefulView {

  #destinationModel = null;
  #offersModel = null;
  #datepicker = null;

  constructor(tripEvent, destinationModel, offersModel) {
    super();
    this._state = AddTripEventView.parseTripEventToState(tripEvent);
  ...
  get template() {
    return createEditTripEventTemplate(this._state, this.#destinationModel, this.#offersModel);
  }
  ...
  #destinationChangeHandler = (evt) => {
    evt.preventDefault();
    if (!isValidDestination(evt.target.value, this.#destinationModel.destinations)) {
      return;
    }
    this.updateElement({
  ...
  #cancelClickHandler = (evt) => {
    evt.preventDefault();
    this._callback.cancelClick(this._state);
  };
